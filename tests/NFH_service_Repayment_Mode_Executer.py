...
if __name__ == "__main__":
    TEST_FILE = "NFH_service_Repayment_Mode.robot"
    TEST_DATA_FILE = "D:/New_automation_/web-automation-framework/resources/test_data/NFH_service_Repayment_Mode.xlsx"
    ...
    tests_to_run = ["Service_Repayment_Mode_EFT"]
