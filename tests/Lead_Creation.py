...
if __name__ == "__main__":
    TEST_FILE = "Lead_Creation.robot"
    TEST_DATA_FILE = "D:/New_automation_/web-automation-framework/resources/test_data/Lead_Creation.xlsx"
    ...
    tests_to_run = ["Lead_Creation_CR_flow_Teller"]
